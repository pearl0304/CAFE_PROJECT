...
export const MenuListData = [
  {
    ...
    description: "푸른 바다를 연상시키는 라떼에 시그니쳐 포션 커피를 직접 부어 쫀득한 치즈크림과 함께 즐길 수 있는 아인슈페너",
  ...
  },
  {
    ...
    image: PineMojitoAde,
    description: "새콤달콤한 파인애플과 싱그러운 라임과 민트가 어우러져 시원하고 청향한 무알콜 모히또 에이드",
  ...
  },
  {
    ...
    description: "달콤한 국내산 수박주스와 시원한 얼음ㅇ르 갈아 넣어 갈증 해소에 탁월한 주스",
  ...
  },
  {
    ...
    image: BlueHawail,
    description: "푸른 바다를 연상시키는 상큼한 베이스에 새콤달콤한 파인애플과 레몬을 더해 눈과 입이 즐거운 블랜디드",
  ...
  },
  {
    ...
    image: RedBeanBingsu,
    description: "고운 밀크 눈꽃 얼음 위에 국내산 팥과 대추칩이 어우러진 오리지널 빙수",
...

  {
    ...
    image: AppleManGo,
    description: "고운 밀크 눈꽃 얼음 위에 달콤하고 쫀득한 애플망고와 치즈케이크가 풍성하게 어우러진 빙수",
  ...
  },
  {
    ...
    description: "세가지 맛의 치즈케이크 큐브와 부드러운 바닐라 아이스크림이 어우러진 빙수",
  ...
  },
  {
    ...
    description: "달콤한 꿀과 상큼한 생자몽이 통째로 어우러져 쌉쓰름한 맛과 달콤한 맛이 조화로운 빙수",
